...
T::Exp *CxExp::UnEx() const
{
  ...
  T::EseqExp *ret =
    new T::EseqExp(new T::MoveStm(new T::TempExp(r), new T::ConstExp(1)),
  ...
  else
  {
    ...
    while (formals && actuals)
    {
      ...
      params_tail = params_tail->tail =
          new T::ExpList(now.exp->UnEx(), nullptr);
                              ...
                              TEMP::Label *label) const
{
  ...
  case A::Oper::NEQ_OP:
    ...
    else
    {
      ...
      // should be int here, tiger does not have integer type
                               ...
                               TEMP::Label *label) const
{
  ...
  E::VarEntry *loopvar_entry =
      new E::VarEntry(level->AllocateLocal(true), TY::IntTy::Instance(), true);
                                 ...
                                 TEMP::Label *label) const
{
  ...
  T::Exp *ret =
      new T::EseqExp(creation, new T::TempExp(r));
